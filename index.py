    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                print("picture+1,have" + str(self.__counter) + "pictures")
                self.__counter += 1
        return

    # 开始获取
    def get_images(self, word='cat'):
...
if __name__ == '__main__':
    ...
    crawler.start('猫咪', 10, 1)  # 抓取关键词为 “二次元 美女”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
